...
// Single Trip solution 1 - slice() & reverse()

const planTrip = function (train,fromStop,toStop) {
  // const line = trains[train];
  const start = trains[train].indexOf(fromStop);
  const end = trains[train].indexOf(toStop);
  // console.log(line);
  // console.log(start);
  // console.log(end);
  ...
  if (start<end) {
    let trip = trains[train].slice(start+1,end+1)
    // console.log(trip);
    console.log(`You must travel through the following stops on the ${train} line: ${trip}.`)
  }

  if (start>end){
      let trip = trains[train].slice(end,start);
      trip.reverse();
      // console.log(trip);
      console.log(`You must travel through the following stops on the ${train} line: ${trip}.`)
  }
...
planTrip("6","33rd","Union Square");
console.log("-------------------------")


planTrip("6","Union Square","33rd");
console.log("-------------------------")
